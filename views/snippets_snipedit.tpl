	...
	<div class="panel-heading">
		<div class="row">
			<div class="col-md-2 ">
				...
				<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>  Return to Snippets
				</button></a>
			</div>
		...
		<div class="panel panel-default panel-table">
		<div class="panel-heading">
		<form method="post" action="/snippets_update/{{name['_id']}}">
...
{{name['desc']}}
			...
			<div class="row">
				...
				<textarea class="form-control" id="name" name="lang" rows="1" control-label>
{{name['lang']}}
...
%end
			...
			<div class="row">
				<div class="col-md-2"> <b>Code:</b> 
				</div>
				<div class="col-md-9">
			
			
				<textarea class="form-control" id="name" name="code" rows="20" >
{{name['code']}}
